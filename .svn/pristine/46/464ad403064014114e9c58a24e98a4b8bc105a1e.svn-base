...
@ComponentScan( basePackages ={"com.hhh.fund.usercenter","com.hhh.fund.waterwx.service","com.hhh.fund.waterwx"}, 
					excludeFilters = @ComponentScan.Filter(value = Controller.class, type = FilterType.ANNOTATION)) 
@EnableJpaRepositories(basePackages = {"com.hhh.fund.usercenter.dao","org.snaker.engine.access.jpa.dao","com.hhh.fund.waterwx.dao"},
					entityManagerFactoryRef="entityManagerFactory",
					transactionManagerRef="transactionManager")
@EnableTransactionManagement(proxyTargetClass=true)
@Import(value = {CachingConfig.class, SecurityConfig.class, LogUploadConfig.class,SchedulingConfig.class})
@EnableScheduling
...
//	logger.info("Retrieve data source : " + dataSource.getConnection().createStatement());
		...
		lcemf.setPackagesToScan("com.hhh.fund.usercenter.entity","com.hhh.fund.waterwx.entity");
