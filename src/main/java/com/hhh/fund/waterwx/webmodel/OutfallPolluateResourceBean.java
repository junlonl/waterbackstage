 ...
 *
 */
public class OutfallPolluateResourceBean {
    ...
    private String therectificationresponsibilityunitStr;
	...
	public void setCreateTime(Date createTime) {
		...
		this.createTimeStr = DateUtils.DateToString_14a(createTime);
	}
	...
	public String getTherectificationresponsibilityunitStr() {
		return therectificationresponsibilityunitStr;
	}

	public void setTherectificationresponsibilityunitStr(String therectificationresponsibilityunitStr) {
		this.therectificationresponsibilityunitStr = therectificationresponsibilityunitStr;
	}

	@Override
	public String toString() {
		return "OutfallPolluateResourceBean [id=" + id + ", rivername=" + rivername + ", rivercode=" + rivercode
				+ ", area=" + area + ", leftorrightbank=" + leftorrightbank + ", outfalltype=" + outfalltype
				+ ", outfallcode=" + outfallcode + ", secondaryunit=" + secondaryunit + ", streetname=" + streetname
				+ ", streetmanager=" + streetmanager + ", village=" + village + ", villagemanager=" + villagemanager
				+ ", position=" + position + ", coordinate=" + coordinate + ", outfallsize=" + outfallsize
				+ ", outfallshape=" + outfallshape + ", polldescription=" + polldescription + ", drainageTo="
				+ drainageTo + ", rectificationmeasures=" + rectificationmeasures
				+ ", therectificationresponsibilityunit=" + therectificationresponsibilityunit
				+ ", therectificationresponsibilityunitStr=" + therectificationresponsibilityunitStr
				+ ", timeofcompletion=" + timeofcompletion + ", remark=" + remark + ", createTime=" + createTime
