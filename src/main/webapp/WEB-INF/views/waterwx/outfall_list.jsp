...
<head>
	...
	<style>
		...
		#dictInfo td,#dictInfo th{padding:10px 1px;}
	 ...
	 <script type="text/javascript" src="${ctx }/js/water/outfall_list.js"></script> 
</head>
<body>
			    ...
			    <div class="data_div_condition">
			    	<table class="condition_table">
			    		<tr height="50%">
			    			...
			    			<td width="7%" class="td-text-align-right">排水口形式:</td>
			    			<td width="26%" class="td-text-align-left">
			    				<!-- <select tabindex="-1" name="gradeSearch" id="gradeSearch" style="width:200px;height:34px;border-radius:4px;"  class="selectpicker" >
								</select> -->
								<input type="text"  id="outfallshape" name="outfallshape" class="form-control" placeholder="Search..." style="border-radius:4px">
			    			</td>
			    		</tr>
			    		<tr height="50%">
			    			<td colspan="4"></td>
			    			<td colspan="3" style="text-align:left;">
                                ...
                                <a href="${ctx}/outFall/downloadTemplate">
    ...
    <div class="modal fade" id="dictUpdate" tabindex="-1" role="dialog" style="width:800px;margin:auto;"
        ...
        <div class="modal-dialog" style="width:780px;">
            <div class="modal-content" style="width:750px;">
                ...
                <div class="modal-body col-lg-12">
                    <form id="dictForm" role="form" method="post" action="${ctx }/outFall/saveOutFallRecord">
					...
					<div style="width:100%;">
						<table style="width:90%;margin:0 auto;">
							...
							<tr>
								...
								<td class="td_odd">排水口形态</td><td><span id="info_outfallshape"></span></td>
								<td class="td_odd">排水口大小</td><td><span id="info_outfallsize"></span></td>
							</tr>
							<tr style="border-bottom:1px solid #b0b0b0;">
								<td class="td_odd">排水口类型</td><td><span id="info_outfalltype"></span></td>
								<td class="td_odd">处理措施</td><td><span id="info_rectificationmeasures"></span></td>
								<td class="td_odd">权属单位</td><td><span id="info_secondaryunit"></span></td>
							</tr>
							<tr style="border-bottom:1px solid #b0b0b0;">
								<td class="td_odd">整改责任单位</td><td><span id="info_therectificationdataonsibilityunit"></span></td>
								<td class="td_odd">完成期限</td><td><span id="info_timeofcompletion"></span></td>
							...
							<tr style="border-bottom:1px solid #b0b0b0;">
								<td class="td_odd">问题描述</td><td><span id="info_polldescription"></span></td>
								<td class="td_odd">备注</td><td colspan="4"><span id="info_remark"></span></td>
							</tr>
