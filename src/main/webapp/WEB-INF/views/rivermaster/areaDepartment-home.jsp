...
<title>三级河长水务管理系统</title>
    ...
    <script src="${ctx}/js/rivermaster/script/sc-areaDepartment-river-master.js" type="text/javascript"></script>
    <link href="${ctx}/js/rivermaster/style/sc-areaDepartment-river-master.css" rel="stylesheet" type="text/css" />
...
<body>
    <div class="HomeDiv">
        ...
        <div class="zhishui">
            ...
            <div class="zhishui-item" id=" item-solve"><img src="${ctx}/js/rivermaster/image/item-2-gray.png" class="item-icon" /><br /><span class="item-name">待解决问题(<span class="item-count">(0)</span></span></div>
            <div class="zhishui-item" id=" item-follow"><img src="${ctx}/js/rivermaster/image/item-3-gray.png" class="item-icon" /><br /><span class="item-name">待跟进问题(<span class="item-count">(0)</span></span></div>
        ...
        <div class="complain-message display-none">
            ...
            <div class="btn selfAccept-btn" style="display:none;" onclick="showSelfAccept()">受理</div>
