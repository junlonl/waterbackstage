...
<title>三级河长水务管理系统</title>
    ...
    <script src="${ctx}/js/rivermaster/script/sc-street-river-master.js" type="text/javascript"></script>
    <link href="${ctx}/js/rivermaster/style/sc-street-river-master.css" rel="stylesheet" type="text/css" />
