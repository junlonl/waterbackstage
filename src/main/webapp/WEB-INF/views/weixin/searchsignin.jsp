...
<head>
    ...
    <script src="../js/weixin/searchsignin.js"></script>
...
<body>
    ...
    <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">河道等级</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <select id="grade" style="width: 100%;height:30px;">
                	<option value="">选择河道等级</option>
                	<option value="1">一般河道</option>
                	<option value="2">重要河道</option>       	
                </select>
            </div>
    </div>
    <div class="weui_cell">
            <div class="weui_cell_hd"><label class="weui_label">行政区域</label></div>
            <div class="weui_cell_bd weui_cell_primary">
                <select style="width: 100%;height:30px;" name="area" id="area">
				</select>
            </div>
    </div>
    <!-- <div class="weui_cell">
            ...
            <div class="weui_cell_bd weui_cell_primary">
                <select class="weui_select" style="height:30px;" name="area" id="area">
                </select>
            </div>
    </div> -->
<!--     <div class="weui_cell">
